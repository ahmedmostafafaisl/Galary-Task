        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1"> Album Images{{ $album->title }}</h5>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> Image </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax', ['url' => 'images'])
    ...
    <script>
        $(document).on('click', '#addImage', function() {
            ...
            setTimeout(function() {
                $('#form-load').load("{{ route('images.create') }}??id={{ $album->id }}")
            }, 1000)
        });
    </script>
@endsection
